...
export const changelogData: ChangelogEntry[] = [
  {
    ...
    version: "2.0.0",
    type: "feature",
    title: "Patch 1.4 Silver Torrent, Rising Star : Flora, Phoxhunter Umbro et 5 nouvelles maps",
    description:
      "Integration complete du patch 1.4 du jeu : sortie officielle de Flora et Hilda, ajout des formes Umbro du Phoxhunter, 5 nouvelles cartes interactives, 12 wallpapers ajoutes et nouveau systeme de bandeaux a expiration automatique.",
    items: [
      "🎮 Re-extraction complete des donnees du jeu jusqu'au patch 1.4.153 \"Silver Torrent, Rising Star\"",
      "🌑 Phoxhunter debloque sa forme Umbro (versions feminine et masculine) avec le nouvel element sombre",
      "✨ Flora officiellement sortie en headliner du patch 1.4 (noblesse Umbro, deja presente comme donnees en 1.3)",
      "🔥 Hilda (Pyro), servante personnelle de Flora, finalisee avec le patch 1.4",
      ...
      "🎭 Showcase personnages reagence : Flora en vedette (Umbro), Su Yi, et les deux formes Umbro du Phoxhunter",
