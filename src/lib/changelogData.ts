...
export const changelogData: ChangelogEntry[] = [
  {
    ...
    version: "2.0.0",
    type: "feature",
    title: "Patch 1.4 Silver Torrent, Rising Star : Flora, Hilda, Bloomfield Station et 5 nouvelles maps",
    description:
      "Integration complete du patch officiel \"Silver Torrent, Rising Star\" : 2 nouveaux personnages (Flora et Hilda), nouvel element Umbro pour le Phoxhunter, region steampunk Flodia Bloomfield Station, 5 cartes interactives, 12 wallpapers et systeme de bandeaux a expiration automatique.",
    items: [
      "🎮 Re-extraction complete des donnees du jeu jusqu'au patch 1.4.153 \"Silver Torrent, Rising Star\"",
      "✨ Flora (Umbro) — nouvelle personnage en vedette, maitrise epee et fusil d'assaut",
      "🔥 Hilda (Pyro) — nouvelle personnage, maitrise double lame et lance-grenade (disponible apres le 30 juin 2026)",
      "🌑 Nouvel element Umbro debloque pour le Phoxhunter (protagoniste joueur), via [Chapitre Noctoyager – Silver Torrent, Rising Star]",
      "🚂 Nouvelle region Flodia Bloomfield Station (incluant Bloomfield Station et Ironworks), gare ferroviaire steampunk d'Icelake",
      "⚔️ +27 skills, +18 Demon Wedges, +157 ressources, nouvelle categorie Calamity Weapons, refonte des items de peche",
      ...
      "🎭 Showcase personnages reagence : Flora en vedette, Su Yi, et les deux formes Umbro du Phoxhunter",
