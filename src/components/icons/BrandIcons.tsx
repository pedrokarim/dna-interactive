// Icônes de marque (source : simple-icons, sauvegardées dans
// public/assets/icons/brands/*.svg). Inlinées ici en `currentColor` pour
// pouvoir les teinter facilement (blanc sur Discord, or sur Google…).
