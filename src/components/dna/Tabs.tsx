    ...
    <div className={cn("flex flex-wrap gap-6", className)}>
      {tabs.map((t) => (
        <button
          ...
          className={cn(
            "relative py-1.5 font-caps text-[0.7rem] uppercase tracking-[0.18em] transition-colors",
            "after:absolute after:-bottom-0.5 after:left-1/2 after:h-px after:-translate-x-1/2 after:bg-gold-bright after:shadow-[0_0_8px_#c2a86a] after:transition-all",
