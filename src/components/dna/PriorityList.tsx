          ...
          {!readOnly && (
            <>
              ...
              <button
                ...
                aria-label={t("remove")}
                className="flex h-4 w-4 shrink-0 items-center justify-center rounded-full border border-white/20 bg-ink/80 text-[0.7rem] leading-none text-muted hover:border-crimson-bright hover:text-crimson-soft focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-crimson-bright/70"
              >
                ×
              </button>
            </>
