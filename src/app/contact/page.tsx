...
export default function ContactPage() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    e.preventDefault();
    // Pour l'instant, on ne fait rien avec les données
    alert("Formulaire soumis ! (Backend à implémenter)");
  };
            ...
            <div className="grid md:grid-cols-2 gap-12">
              ...
              <div className="bg-linear-to-br from-slate-800/50 to-slate-900/50 backdrop-blur-sm border border-indigo-500/20 rounded-xl p-8">
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  <button
                    type="submit"
                    className="w-full bg-linear-to-r from-indigo-600 to-purple-600 hover:from-indigo-700 hover:to-purple-700 rounded-lg py-3 px-6 font-semibold text-white transition-all duration-300 transform hover:scale-105"
                  >
                    Envoyer le message
                  </button>
                </form>
                ...
                <p className="text-sm text-gray-500 mt-4 text-center">
                  * Ce formulaire est actuellement en mode démonstration.
                  Le backend sera implémenté prochainement.
                </p>
              </div>
            </div>
          </div>
