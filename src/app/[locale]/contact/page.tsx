        ...
        <div className="space-y-8">
          ...
          <DnaPanel className="p-7 md:p-8">
            ...
            <a
              ...
              className={`dna-shine inline-flex items-center gap-2 rounded-sm border px-6 py-3 font-medium transition-all duration-200 hover:-translate-y-px ${DISCORD_BUTTON_CLASS}`}
            >
        ...
        <DnaPanel className="p-7 md:p-8">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div>
              ...
              {/* Une liste de cinq options courtes n'a pas besoin de toute la
                  largeur de la colonne : la taille du champ annonce ce qu'on
                  attend dedans. `max-w` seulement, donc il se réduit tout seul
                  sur un écran étroit. */}
              <select id="subject" name="subject" value={formData.subject} onChange={handleChange} className={`${INPUT_CLASS} max-w-sm`} required>
