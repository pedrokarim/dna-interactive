        ...
        <div className="container mx-auto px-6">
          <div className="flex flex-col md:flex-row items-center justify-between">
            ...
            <nav className="flex flex-wrap items-center justify-center gap-x-4 gap-y-2 text-sm text-slate-300 md:gap-x-6">
              <Link href={NAVIGATION.home} className="hover:text-indigo-300 transition-colors">
                {tn('home')}
              </Link>
              <Link href={NAVIGATION.map} className="hover:text-indigo-300 transition-colors">
                {tn('map')}
              </Link>
              <Link href={NAVIGATION.items} className="hover:text-indigo-300 transition-colors">
                {tn('items')}
              </Link>
              <Link href={NAVIGATION.about} className="hover:text-indigo-300 transition-colors">
                {tn('about')}
              </Link>
              <Link href={NAVIGATION.support} className="hover:text-indigo-300 transition-colors">
                {tn('support')}
              </Link>
            </nav>
          </div>
