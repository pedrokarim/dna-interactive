...
import HomePocClient, { type HomeBuildCard, type HomeCode } from "./HomePocClient";
...
/** Proof of concept — nouvelle home façon « hub / dashboard », câblée sur les vraies données. */
export default async function HomePocPage({ params }: { params: Promise<{ locale: string }> }) {
