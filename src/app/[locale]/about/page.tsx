          ...
          <div className="text-center">
            ...
            <div className="flex flex-col justify-center gap-4 sm:flex-row">
              <a
                ...
                className={`dna-shine inline-flex items-center justify-center gap-2 rounded-sm border px-6 py-3 font-medium transition-all duration-200 hover:-translate-y-px ${DISCORD_BUTTON_CLASS}`}
              >
